...
This API will contain the following features, that live all within the `ansi_colors` **namespace**: 
  ...
  **(NOTE):** *Virtual terminal processing* and therefore this **API** on **Windows hosts** is only available for `Windows 10` hosts: **`v1511 (build 10586)`**, **`v1903 (build 18362)`** or *higher*; and for `Windows Server 2016` or *higher*; 
